  ...
  return (
    <div className="report">
        ...
        <div className="left">
          {selectedSchool ? (
            ...
            <div style={{ textAlign: "center", fontSize: 24 }}>
              {" "}
              ⇒⇒ יש להזין בשורת החיפוש שם ישוב או שם ביה"ס
            </div>
          )}
        </div>
      </div>
      ...
      <div className="footer">
        <div>
          הדו״ח מתבסס על נתוני הלשכה המרכזית לסטטיסטיקה. בדו״ח נספרו עבור כל בית
          ספר כל הפצועים/ההרוגים הולכי הרגל בגילאים 0-19 בתאונות שעיגונן מדויק
          ובתוך ריבוע שמרכזו בית הספר וגודל כל צלע ק"מ אחד, בין השנים 2014-2018.
        </div>
        <div>
